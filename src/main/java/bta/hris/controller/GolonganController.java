...
public class GolonganController {
    ...
    public String tambahGolonganSubmit(@ModelAttribute GolonganModel golongan, Model model,
    ...
    public String ubahGolonganSubmit(@PathVariable Long idGolongan, @ModelAttribute GolonganModel golongan, Model model,
            RedirectAttributes redirect) {
